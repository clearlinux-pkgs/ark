...
Version  : 18.08.1
Release  : 6
URL      : https://github.com/KDE/ark/archive/v18.08.1.tar.gz
Source0  : https://github.com/KDE/ark/archive/v18.08.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1536298861
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libkerfuffle.so.18.8.1
