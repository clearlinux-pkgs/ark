...
Version  : 23.04.2
Release  : 73
URL      : https://download.kde.org/stable/release-service/23.04.2/src/ark-23.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/ark-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/ark-23.04.2.tar.xz.sig
...
%prep
%setup -q -n ark-23.04.2
cd %{_builddir}/ark-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686510520
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkerfuffle.so.23.04.2
...
/usr/lib64/libkerfuffle.so.23.04.2
