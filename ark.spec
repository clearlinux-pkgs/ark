...
Version  : 18.07.90
Release  : 3
URL      : https://github.com/KDE/ark/archive/v18.07.90.tar.gz
Source0  : https://github.com/KDE/ark/archive/v18.07.90.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1533310299
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
cp COPYING.icons %{buildroot}/usr/share/doc/ark/COPYING.icons
pushd clr-build
%make_install
popd
...
/usr/lib64/libkerfuffle.so.18.7.90
...
/usr/share/doc/ark/COPYING.icons
