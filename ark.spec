...
Source0  : https://download.kde.org/stable/release-service/21.04.0/src/ark-21.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.04.0/src/ark-21.04.0.tar.xz.sig
...
%prep
%setup -q -n ark-21.04.0
cd %{_builddir}/ark-21.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619199984
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ark-21.04.0/COPYING %{buildroot}/usr/share/package-licenses/ark/7c203dee3a03037da436df03c4b25b659c073976
cp %{_builddir}/ark-21.04.0/COPYING.icons %{buildroot}/usr/share/package-licenses/ark/69420a3ad87532e76ad02ac77b78f5dfff3cfc01
pushd clr-build
%make_install
popd
%find_lang ark
...
/usr/lib64/libkerfuffle.so.21.4.0
