...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/ark-22.08.0.tar.xz
...
%prep
%setup -q -n ark-22.08.0
cd %{_builddir}/ark-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661539084
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkerfuffle.so.22.08.0
