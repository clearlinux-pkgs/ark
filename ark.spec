...
Source0  : https://download.kde.org/stable/release-service/24.08.1/src/ark-24.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.1/src/ark-24.08.1.tar.xz.sig
...
%setup -q -n ark-24.08.1
cd %{_builddir}/ark-24.08.1
pushd ..
cp -a ark-24.08.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726170638
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkerfuffle.so.24.08.1
...
/usr/lib64/libkerfuffle.so.24.08.1
