...
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/ark-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/ark-24.02.1.tar.xz.sig
...
%prep
%setup -q -n ark-24.02.1
cd %{_builddir}/ark-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711065453
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkerfuffle.so.24.02.1
...
/usr/lib64/libkerfuffle.so.24.02.1
