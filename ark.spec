...
Version  : 22.08.1
Release  : 62
URL      : https://download.kde.org/stable/release-service/22.08.1/src/ark-22.08.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/ark-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/ark-22.08.1.tar.xz.sig
...
%prep
%setup -q -n ark-22.08.1
cd %{_builddir}/ark-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662762308
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkerfuffle.so.22.08.1
