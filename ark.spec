...
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/ark-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/ark-24.12.3.tar.xz.sig
...
%setup -q -n ark-24.12.3
cd %{_builddir}/ark-24.12.3
pushd ..
cp -a ark-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742446421
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkerfuffle.so.24.12.3
...
/usr/lib64/libkerfuffle.so.24.12.3
