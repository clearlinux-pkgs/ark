...
%setup -q -n ark-24.08.2
cd %{_builddir}/ark-24.08.2
pushd ..
cp -a ark-24.08.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728589481
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkerfuffle.so.24.08.2
...
/usr/lib64/libkerfuffle.so.24.08.2
